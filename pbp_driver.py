...
def trunc_driver(c, p_list):
    ...
    This function creates a polynomial basis representation (pBp) using the create_pbp function with the input matrix C.
    It then prints the resulting pBp and the corresponding polynomial. The function then iterates over the p_list and
    truncates the pBp using the truncate_pBp function for each cutoff value p. The truncated pBp and the corresponding
    polynomial are printed for each p value.

    Example:
        >>> c = np.array([[7, 8, 2, 10, 3], [4, 12, 1, 8, 4], [5, 3, 0, 6, 9], [9, 6, 7, 1, 5]])
        >>> p_list = [3, 5, 7]
        >>> trunc_driver(c, p_list)
        Result pBp
        11 + 1y1 + 1y2 + 4y3 + 5y4 + 1y1y2 + 3y2y3 + 4y3y4 + 7y1y2y3 + 4y1y2y4 + 4y1y3y4 + 2y2y3y4
        ====================================================================================================
        p = 1
        11 + 1y1 + 1y2 + 4y3 + 5y4 + 1y1y2 + 3y2y3 + 4y3y4 + 7y1y2y3 + 4y1y2y4 + 4y1y3y4 + 2y2y3y4
        ====================================================================================================
        p = 2
        11 + 1y1 + 1y2 + 4y3 + 5y4 + 1y1y2 + 3y2y3 + 4y3y4
        ====================================================================================================
        p = 3
        11 + 1y1 + 1y2 + 4y3 + 5y4
        ====================================================================================================
...
if __name__ == "__main__":
    ...
    # perm = create_perm(C)
    # print([perm])
    # coeffs = create_coeffs_matrix(C, perm)
    # print([coeffs])
